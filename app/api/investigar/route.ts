...
import { buscarEmendasPorAutor as buscarTransfereGovPorAutor, buscarEmendasPorMunicipio as buscarTransfereGovPorMunicipio, buscarEmendasPorCNPJ, gerarResumoEmendasPIX } from '../../../lib/transferegov/client';
...
export async function GET(request: Request) {
  ...
  } = await import('../../../lib/services/request-parser');
  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        } = await import('../../../lib/services/investigador-principal');
