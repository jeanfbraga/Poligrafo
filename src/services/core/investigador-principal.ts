...
import { buscarEmendasPorMunicipio as buscarTransfereGovPorMunicipio, buscarEmendasPorAutor as buscarTransfereGovPorAutor, gerarResumoEmendasPIX, buscarEmendasPorCNPJ } from '../integrations/transferegov/client';
...
import { buscarEnteSiconfi, consultarIndicadoresLRF } from '../integrations/siconfi/client';
import { consultarPNAE, consultarFUNDEB, consultarPNATE } from '../integrations/fnde/client';
  ...
  try {
    {
      ...
      try {
        ...
        } = await import('@/services/core/socio-search');
