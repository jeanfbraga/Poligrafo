	...
	try {
		...
		if (!nomePolitico) {
			return NextResponse.json(
				{ error: "Nome do político é obrigatório." },
				{ status: 400 },
			);
		}
				...
				},
				{
					...
					children: [
						new Paragraph({
							...
							children: [
								new TextRun({
									text: "⚠️ ENTIDADES FLAGRADAS PELA INTELIGÊNCIA ARTIFICIAL",
									bold: true,
									size: 28,
									color: COLORS.RED,
									font: "Consolas",
						...
						new Paragraph({
							...
							children: [
								new TextRun({
									text: `Total de alertas: ${despesasCriticas?.length || 0} entidade(s) com score de risco ≥ 60`,
									size: 18,
									color: COLORS.GRAY,
									font: "Consolas",
								}),
