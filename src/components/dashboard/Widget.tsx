...
import { type LucideIcon, ShieldAlert, Terminal } from "lucide-react";
...
export function Widget({
	...
	return (
		<div
			ref={containerRef}
			className="border border-green-900/50 bg-black p-4 relative flex flex-col h-full shadow-[0_0_15px_rgba(0,34,0,0.5)]"
		>
			{/* Canto cortado estilo cyberpunk */}
			<div
				className="absolute top-0 right-0 w-4 h-4 bg-[#050505] border-l border-b border-green-900/50"
			...
			<div className="flex items-center gap-2 mb-4 pb-2 border-b border-green-900/30">
				...
				<div className="flex flex-col">
					<h3 className="text-sm font-bold text-green-500 tracking-widest uppercase leading-tight">
						{title}
					</h3>
					{subtitle && (
						<span className="text-xs text-green-700 tracking-wider uppercase mt-0.5">
							{subtitle}
						</span>
					)}
				</div>
