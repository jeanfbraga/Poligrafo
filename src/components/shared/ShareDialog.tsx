...
function getCardTheme(score = 0, isFantasma = false) {
	...
	if (level === "critico") {
		return {
			cardBorder: "border-red-600 shadow-[inset_0_0_100px_rgba(239,68,68,0.1)]",
			badge: "bg-red-950/50 text-red-500 border border-red-500/50",
			text: "text-red-400",
			valueText: "text-red-500",
			motivoBox: "border-red-500/50 bg-red-950/30",
			motivoText: "text-red-500",
		};
	}
	if (level === "atencao") {
		return {
			cardBorder: "border-yellow-500 shadow-[inset_0_0_100px_rgba(234,179,8,0.1)]",
			badge: "bg-yellow-950/50 text-yellow-500 border border-yellow-500/50",
			text: "text-yellow-400",
			valueText: "text-yellow-500",
			motivoBox: "border-yellow-500/50 bg-yellow-950/30",
			motivoText: "text-yellow-500",
		};
	}
	return {
		...
		motivoBox: "border-slate-600/50 bg-slate-900/30",
		motivoText: "text-slate-400",
	};
}
...
function getSocialShareUrl(platform: "whatsapp" | "telegram" | "twitter", data: ShareData): string {
	...
	if (platform === "telegram") {
		return `https://t.me/share/url?url=${encodeURIComponent("https://poligrafo.app")}&text=${encoded}`;
	}
			...
			>
				...
				>
					...
					<div className="flex-1 flex flex-col gap-6 relative z-10">
						...
						<div className={`p-12 border-l-12 bg-black/80 shadow-2xl relative overflow-hidden ${theme.cardBorder}`}>
