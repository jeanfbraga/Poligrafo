...
-- ═══════════════════════════════════════════════════════════════════════════════
-- 0. MODELO CANÔNICO UNIFICADO (Escalabilidade Nacional: Federal, Estadual e Municipal)
-- ═══════════════════════════════════════════════════════════════════════════════

-- 0.1 politicos — Cadastro Unificado de Agentes Públicos
...
-- 0.2 orgaos_publicos — Entidades da Administração Pública
...
-- 0.3 mandatos — Vínculo de Mandato entre Político e Órgão
...
-- 0.4 despesas_publicas — Registro Canônico Unificado de Despesas
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- 1. TABELAS BASE (INVESTIGAÇÃO & CACHES ESPECÍFICOS)
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 1.9.1 aracaju_despesas — Despesas e Contratos de Aracaju (CMA e Prefeitura)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ----------------------------------------------------------------------------------------------------
-- 1.18 camara_proposicoes_detalhes_cache
-- ----------------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------------
-- 1.19 camara_servidores_gabinete
-- ----------------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------------
-- 1.21 ÍNDICES DE PERFORMANCE (Tabelas de Perfil)
-- ----------------------------------------------------------------------------------------------------
...
-- Constraints de FK para tabelas já existentes
DO $$ BEGIN
